  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelapor/profile' ||
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelapor/profile/'
          ): ?>
            <a href="<?= base_url('pelapor/profile'); ?>" class="nav-link active"><i class="nav-icon fas fa-fw fa-user"></i>
              <p><?= $dataUser['username']; ?></p>
            </a>
          <?php else: ?>
            <a href="<?= base_url('pelapor/profile'); ?>" class="nav-link"><i class="nav-icon fas fa-fw fa-user"></i>
              <p><?= $dataUser['username']; ?></p>
            </a>
          <?php endif ?>
        </li>
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelapor' ||
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelapor/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporPengaduan/addPelaporPengaduan' ||
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporPengaduan/addPelaporPengaduan/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporPengaduan' ||
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporPengaduan/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporLaporan' ||
            $_SERVER['REQUEST_URI'] == '/yang_mulia/pelaporLaporan/'
          ): ?>
